    ...
    public function load(ObjectManager $manager)
    {
        $films = [
            [
                ...
                'affiche' => '8370ecf72ae726258ec40634d778e091.jpeg', 'studio' => 'studio_2', 'cast' => ['cast_2', 'cast_3', 'cast_4'],'user' => ['user_2', 'user_3', 'user_1']
            ], [
                'title' => 'Lords of Person', 'date' => '2016-04-25', 'description' => 'ils vecurent heureux', 'category' => 'category-4',
                'affiche' => '8370ecf72ae726258ec40634d778e091.jpeg', 'studio' => 'studio_1', 'cast' => ['cast_2', 'cast_6', 'cast_1'],'user' => ['user_2', 'user_3', 'user_1']
            ], [
                ...
                'affiche' => '8370ecf72ae726258ec40634d778e091.jpeg', 'studio' => 'studio_6', 'cast' => ['cast_2', 'cast_3', 'cast_7'],'user' => ['user_2', 'user_3', 'user_1']
            ], [
        ...
        foreach ($films as $value) {
            ...
            $film
                ...
                ->addCast($this->getReference($value{'cast'}[0]))
                ->addCast($this->getReference($value{'cast'}[1]))
                ->addCast($this->getReference($value{'cast'}[2]))
                ->addUser($this->getReference($value{'user'}[0]));
